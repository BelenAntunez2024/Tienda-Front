...
function FormularioCompra() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const carritoRes = await fetch(`https://wisteriaback.onrender.com/item-ordenes/carrito/${userId}`, {
    ...
    try {
      const response = await fetch("https://wisteriaback.onrender.com/ordenes/comprar", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        await fetch(`https://wisteriaback.onrender.com/item-ordenes/vaciar-carrito/${userId}`, {
          method: "DELETE",
          headers: { "Authorization": `Bearer ${token}` }
        });
